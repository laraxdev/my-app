...
import MAB from "../assets/Mario-and-Adrian-b.jpg";
    ...
    <section name="about" className="about">
      ...
      <div className="about-image-container">
        <div className="about-container-one">
          <img src={MAA} alt="Mario and Adrian 1" className="about-image-one" />
        </div>
        <div className="about-container-two">
          <img src={MAB} alt="Mario and Adrian 2" className="about-image-two" />
        </div>
      </div>
    </section>
  );
